...
const COPY = {
  en: {
    ...
    heroTitle: "Build judgment,<br />not just recall.", heroBody: "Practice 5,388 AWS SAA questions mapped to the official SAA-C03 content domains and tasks.",
  ...
  ko: {
    ...
    heroTitle: "암기보다<br />판단력을 키우세요.", heroBody: "업로드한 AWS SAA 전체 5,388문제를 공식 SAA-C03 도메인과 태스크 기준으로 연습하세요.",
